...
<div class="container-fluid">
	<div class="row">
			...
			<div class="left-side sticky-left-side" >
		        ...
		        <div class="left-side-inner" >
		            <ul class="nav nav-pills nav-stacked custom-nav" > 
		                ...
		                <li><a href="<%=path %>/ZongWuListAction" target="myframe"><i class="fa fa-laptop"></i> <span>组织机构管理</span></a></li>
		                <li class="menu-list"><a href="#" target="myframe"><i class="fa fa-cogs"></i> <span>员工管理</span></a>
		                    <ul class="sub-menu-list">
		                        ...
		                        <li><a href="#" target="myframe"> 员工信息管理</a></li>
		                    </ul>
		                </li>
		                <li class="menu-list"><a href=""><i class="fa fa-pencil fa-fw"></i> <span>员工信息查询统计</span></a>
		                    <ul class="sub-menu-list">
		                        ...
		                        <li><a href="<%=path %>/statistics/statistics_view.jsp" target="myframe"> 汇总统计</a></li>
		                    </ul>
		                </li>
		...
		<div class="main-content" >
			<iframe src="<%=path%>/welcome.jsp" name="myframe" width="100%" height="620" frameborder="0" scrolling="yes" style="padding-top: 16px"></iframe>
		</div>	
	</div>
</div>
